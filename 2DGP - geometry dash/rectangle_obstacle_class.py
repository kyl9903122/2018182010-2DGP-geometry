...
class RECTANGLE_OBSTCLE:
    ...
    def __init__(self, x, y, size):
        ...
        if RECTANGLE_OBSTCLE.image_1 == None:
            RECTANGLE_OBSTCLE.image_1 = load_image('Rect_Obstacle200x200.png')
        if RECTANGLE_OBSTCLE.image_2 == None:
            RECTANGLE_OBSTCLE.image_2 = load_image('Rect_Obstacle250x250.png')
        if RECTANGLE_OBSTCLE.image_3 == None:
            RECTANGLE_OBSTCLE.image_3 = load_image('Rect_Obstacle300x300.png')
        if RECTANGLE_OBSTCLE.image_3 == None:
            RECTANGLE_OBSTCLE.image_3 = load_image('Rect_Obstacle350x350.png')
        if RECTANGLE_OBSTCLE.image_3 == None:
            RECTANGLE_OBSTCLE.image_3 = load_image('Rect_Obstacle400x400.png')
